...
st.header("🐱 Animal Classification Chatbot 🐒")

# Input and submit button
input_animal = st.text_input("Enter the name of an animal: ", key="input")
submit = st.button("Check Animal Status")

# If the question is submitted
if submit and input_animal:
